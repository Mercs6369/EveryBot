...
public class Robot extends TimedRobot {
  ...
  SparkMaxPIDController m_Arm_Controller;
  ...
  public void robotInit() {
    ...
    */
    ...
    m_Arm_Controller = arm.getPIDController();
    m_Arm_Controller.setP(0.15);
    m_Arm_Controller.setOutputRange(-0.45, 0.45);
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("Arm getRelativeEncoder", arm.getEncoder().getPosition());
  ...
  public void teleopPeriodic() {
    ...
    if (p.getRawButton(9)){
      ...
      //setArmMotor(-0.45);
      m_Arm_Controller.setReference(16, CANSparkMax.ControlType.kPosition);}
